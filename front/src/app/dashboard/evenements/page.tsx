...
export default function EvenementsPage() {
  ...
  if (!canRead) {
    return (
      <PageShell>
        <PageHeader
          title="Événements"
          description="Vous n'avez pas accès aux événements."
        />
      </PageShell>
    );
  }
  ...
  return (
    <PageShell>
      <PageHeader
        title="Événements"
        description="Créez et publiez des événements pour le groupe. La publication envoie une invitation à tous les collaborateurs connectés — maison mère et filiales."
      />
