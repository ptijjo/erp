...
export const SUBJECT_LABELS: Record<PolicySubject, string> = {
  ...
  StrategyProject: "Projets stratégie",
  MarketingCampaign: "Campagnes marketing",
  SpiritualEvent: "Événements spirituels",
  SpiritualArticle: "Articles spirituels",
  ChartAccount: "Plan comptable",
...
export const POLICY_SUBJECT_GROUPS: {
  ...
  },
  {
    id: "comptabilite",
    label: "Comptabilité",
    subjects: ["ChartAccount", "JournalEntry"],
  },
  {
    id: "finance",
    label: "Finance",
