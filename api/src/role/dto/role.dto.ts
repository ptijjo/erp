...
export class CreateRoleDto {
  ...
  /** Obligatoire si le périmètre est la maison mère (VIFAA) ; interdit pour filiale ou rôle global. */
  @IsUUID('4', { message: "L'identifiant de pôle doit être un UUID valide" })
  @IsOptional()
